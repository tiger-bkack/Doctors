          ...
          {Array.isArray(reportData) && reportData.length > 0 ? (
            reportData.map((items, index) => (
              ...
              >
                ...
                <div
                  dir="rtl"
                  className="mt-10 w-[73%] bg-white m-auto shadow-lg flex items-center"
                >
                  <button
                    className="py-1 px-10 w-[20%] flex items-center justify-center gap-2 group cursor-pointer border-l border-gray-300"
                    onClick={() => handlePrint(reportRefs.current[index])}
                  >
                    <p className="text-gray-500 group-hover:text-gray-900">
                      طباعه
                    </p>
                    <FaPrint className="text-[20px] text-gray-500 group-hover:text-gray-900" />
                  </button>
                  ...
                  >
                    ...
                    <FaRegEdit className="text-[20px] text-gray-500 group-hover:text-gray-900" />
                  </button>
                  ...
                  >
                    ...
                    <MdDelete className="text-[20px] text-gray-500 group-hover:text-gray-900" />
                  </button>
                  ...
                  <button className="py-1 px-10 w-[20%] flex items-center justify-center gap-2 group cursor-pointer">
                    ...
                    <FaShare className="text-[20px] text-gray-500 group-hover:text-gray-900" />
                  </button>
                </div>
