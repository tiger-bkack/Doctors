      ...
      <ModalBody>
        <div className="space-y-3  ">
          <form onSubmit={handelAddConsaltation} id="consaltation">
            <div className="space-y-3">
              <p className="text-white text-lg">chose day to consaltation :</p>
              <input
                value={consaltationDay}
                onChange={(e) => setConsaltationDay(e.target.value)}
                type="date"
                className="w-full py-2 active:bg-[#5f6fff] border px-2 rounded-md border-gray-300 text-white cursor-pointer"
              />
            </div>
            <div className="space-y-2 mt-5">
              <p className="text-white text-lg">If you have any notes :</p>
              <textarea
