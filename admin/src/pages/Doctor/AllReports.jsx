        ...
        <div className="max-h-[95vh] min-h-[90vh] overflow-y-scroll">
          {reportData.map((items, index) => (
            <div className="flex flex-col justify-center items-center ">
              <div
                dir="rtl"
                className="  mt-10 w-[75%] bg-white m-auto  shadow-lg  my-0 flex items-center justify-baseline "
              >
                <button
                ...
                <button className="py-1 px-10 w-[25%]  text-sm flex items-center justify-center gap-2 group cursor-pointer border-l-1 border-gray-500">
                  <p className="text-gray-500 group-hover:text-gray-900 transition-all duration-150">
                    تعديل التقرير
                  </p>
                  <FaRegEdit className="text-[20px]  text-gray-500 group-hover:text-gray-900 transition-all duration-150" />
                </button>
                <button className="py-1 px-10 w-[20%]  flex items-center justify-center group cursor-pointer border-l-1 border-gray-500">
                  حفظ التعديل
                </button>
                <button className="py-1 px-10 w-[20%]  flex items-center justify-center group cursor-pointer border-l-1 border-gray-500">
                  مشاركة
